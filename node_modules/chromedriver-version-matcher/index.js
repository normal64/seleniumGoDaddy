...
var chromeFinder = require("chrome-launcher/dist/chrome-finder");
var chromeUtils = require("chrome-launcher/dist/utils");
...
function getVersionIndex() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, fs.readJson(path.join(__dirname, 'src', 'version-index.json'))];
        });
    });
}
